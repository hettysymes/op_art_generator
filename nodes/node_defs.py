...
from id_datatypes import PropKey, NodeId, PortId, input_port, EdgeId
...
from nodes.prop_types import PropType, PT_List, PT_PointsHolder, PT_ElementHolder, PT_FillHolder, \
    PT_ValProbPairHolder
from nodes.prop_values import PropValue, List, PortRefTableEntry, ElementRef, FillRef, LineRef, ValProbPairRef
from nodes.shape_datatypes import Group
from vis_types import ErrorFig, Visualisable
...
class NodeCategory(Enum):
    ...
    LINE = (2, "Lines")
    CANVAS = (3, "Canvases")
    DRAWING_COMPOSER = (4, "Drawing Composers")
    DRAWING_MODIFIER = (5, "Drawing Modifiers")
    BASE_PROPERTY = (6, "Base Properties")
    PROPERTY_MODIFIER = (7, "Property Modifiers")
    PROPERTY_SAMPLER = (8, "Property Samplers")
    ITERATOR = (9, "Iterators")
    SELECTOR = (10, "Selectors")
    COLLATOR = (11, "Collators")
    LIST_MODIFIER = (12, "List Modifiers")
    PORT_FORWARDER = (13, "Port Forwarders")
    ANIMATOR = (14, "Animators")
    UNKNOWN = (15, "Others")
