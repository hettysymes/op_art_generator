...
DEF_SINE_WAVE_INFO = NodeInfo(
    ...
    prop_entries={
        'amplitude': PropEntry(PrT_Float(),
                               ...
                               default_value=0.5),
        'wavelength': PropEntry(PrT_Float(),
        ...
        'centre_y': PropEntry(PrT_Float(),
                              ...
                              default_value=0.5),
        'phase': PropEntry(PrT_Float(),
                           display_name="Phase (°)",
                           description="Phase of the sine wave in degrees.",
                           default_value=0.0),
        'x_min': PropEntry(PrT_Float(),
...
DEF_RECTANGLE_NODE_INFO = NodeInfo(
    ...
    port_defs={(PortIO.INPUT, 'fill'): PortDef("Fill", PT_Fill()),
               (PortIO.OUTPUT, '_main'): PortDef("Drawing", PT_Element())},
    prop_entries={'fill': PropEntry(PrT_Fill(),
                                    display_name="Fill",
